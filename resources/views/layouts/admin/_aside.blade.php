...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{ request()->is('*home*') ? 'active' : '' }}"
                href="{{ route('admin.home') }}"><i class="app-menu__icon fa fa-home"></i> <span
                    class="app-menu__label">@lang('site.home')</span></a></li>
        ...
        @if (auth()->user()->hasPermission('read_tours'))
            <li><a class="app-menu__item {{ request()->is('*tours*') ? 'active' : '' }}"
        ...
        @if (auth()->user()->hasPermission('read_movies'))
            <li><a class="app-menu__item {{ request()->is('*orders*') ? 'active' : '' }}"
                    href="{{ route('admin.orders.index') }}"><i class="app-menu__icon fa fa-film"></i> <span
                        class="app-menu__label">@lang('orders.order')</span></a></li>
        @endif
        ...
        @if (auth()->user()->hasPermission('read_actors'))
            <li><a class="app-menu__item {{ request()->is('*actors*') ? 'active' : '' }}"
                    ...
                    <span class="app-menu__label">@lang('actors.actors')</span></a></li>
        @endif
