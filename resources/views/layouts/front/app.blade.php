...
<!-- Mirrored from demo.dedemao.com/h5/13482/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 12:03:41 GMT -->
...
<head>
    ...
    <!-- Google Fonts -->
    <link
        href="../../../fonts.googleapis.com/css29da0.css?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap"
        rel="stylesheet">
    <link
        href="../../../fonts.googleapis.com/css278ca.css?family=Work+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap"
        rel="stylesheet">
...
<body>
        ...
        <div class="preloader">
            ...
            <div id="handle-preloader" class="handle-preloader">
                <div class="animation-preloader">
                    ...
                    <img src="https://loading.io/assets/img/c/icon/sunny-light.svg" alt="">
                    <div class="txt-loading">
                        <span data-text-preloader="S" class="letters-loading">S</span> <span data-text-preloader="I"
                            class="letters-loading">I</span> <span data-text-preloader="N"
                            class="letters-loading">N</span> <span data-text-preloader="D"
                            class="letters-loading">D</span> <span data-text-preloader="B"
                            class="letters-loading">B</span> <span data-text-preloader="A"
                            class="letters-loading">A</span> <span data-text-preloader="D"
                            class="letters-loading">D</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="header-lower">
            <div class="outer-box clearfix">
                <div class="menu-area pull-left clearfix">
                    <div class="logo-box">
                        <figure class="logo">
                            <a href="index.html"><img src="{{ asset('front/assets/images/logo_main.png') }}"
                                    alt=""></a>
                        </figure>
                    </div>
                        ...
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="destination.html">Destinations 01</a>
                                        </li>
                                        <li>
                                            <a href="destination-2.html">Destinations 02</a>
                                        </li>
                                        <li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="tour-1.html">Tours Grid</a>
                                        </li>
                                        <li>
                                            <a href="tour-2.html">Tours List</a>
                                        </li>
                                        <li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="booking-1.html">Booking Process</a>
                                        </li>
                                        <li>
                                            <a href="tour-deals.html">Tour Deals</a>
                                        </li>
                                        <li>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-xl-6 column">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="tour-element-1.html">Tour Block 01</a>
                                                    </li>
                                                    <li>
                                                        <a href="tour-element-2.html">Tour Block 02</a>
                                                    </li>
                                                    <li>
                                                        <a href="place-element-1.html">Place Block 01</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-xl-6 column">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="place-element-2.html">Place Block 02</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="funfact-element.html">Funfact Block</a>
                                                    </li>
                                                    <li>
                ...
                <ul class="menu-right-content pull-right clearfix">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu search-panel" aria-labelledby="dropdownMenu3">
                                <div class="form-container">
                                    <form method="post" action="http://demo.dedemao.com/h5/13482/blog.html">
                                        <div class="form-group">
                                            <input type="search" name="search-field" value="" placeholder="Search...."
                                                required=""><button type="submit" class="search-btn"><span
                    ...
                    <li class="btn-box ">
                        <a href="tour-deals.html" class=" green-bg theme-btn">Book A Flight</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="sticky-header">
            <div class="auto-container">
                <div class="outer-box">
                    <div class="logo-box">
                        <figure class="logo">
                            <a href="index.html"><img src="front/assets/images/logo_main.png" alt=""></a>
                        </figure>
                    </div>
                    <div class="menu-area">
                                        ...
                                        <form method="post" action="http://demo.dedemao.com/h5/13482/blog.html">
                                            <div class="form-group">
                                                <input type="search" name="search-field" value=""
                                                    ...
                                                    class="search-btn"><span class="fas fa-search"></span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo">
                <a href="index.html"><img src="front/assets/images/logo-2.png" alt="" title=""></a>
            </div>
            ...
            <div class="contact-info">
                ...
                <ul>
                    <li>Chicago 12,Melborne City,USA
                    </li>
                    <li>
    ...
    <footer class="main-footer bg-color-2">
        <div class="footer-top">
            <div class="vector-bg" style="background-image: url(front/assets/images/shape/shape-11.png);">
            </div>
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                        <div class="footer-widget logo-widget">
                            <figure class="footer-logo">
                                <a href="index.html"><img width="170" src="front/assets/images/logo_main.png"
                                        alt=""></a>
                            </figure>
                            <div class="text">
                                <p>
                                    Lorem ipsum dolor amet consetetur adi pisicing elit sed eiusm tempor in cididunt
                                    ...
                                    <li>
                                        <figure class="image-box">
                                            <a href="gallery-1.html"><img
                                                    src="front/assets/images/resource/footer-gallery-1.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li>
                                        <figure class="image-box">
                                            <a href="gallery-1.html"><img
                                                    src="front/assets/images/resource/footer-gallery-2.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li>
                                        <figure class="image-box">
                                            <a href="gallery-1.html"><img
                                                    src="front/assets/images/resource/footer-gallery-3.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li>
                                        <figure class="image-box">
                                            <a href="gallery-1.html"><img
                                                    src="front/assets/images/resource/footer-gallery-4.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li>
                                        <figure class="image-box">
                                            <a href="gallery-1.html"><img
                                                    src="front/assets/images/resource/footer-gallery-5.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                    <li>
                                        <figure class="image-box">
                                            <a href="gallery-1.html"><img
                                                    src="front/assets/images/resource/footer-gallery-6.jpg" alt=""></a>
                                        </figure>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="footer-widget contact-widget">
                            ...
                            <div class="widget-content">
                                <ul class="info-list clearfix">
                                    <li>
                                        <i class="fas fa-map-marker-alt"></i>Flat 20,Reynolds Neck,North
                                        Helenaville,FV77 8WS
                                    </li>
                                    <li>
                                        <i class="fas fa-microphone"></i><a href="#">+2(305) 587-3407</a>
                                    </li>
                                    <li>
            ...
            <div class="auto-container">
                <div class="bottom-inner clearfix">
                    <div class="copyright pull-left">
                        <p>
                            <a href="index.html">Sindbad Balloon</a>©2021 All Right By <a
                                href="../../../www.dedemao.com/index.html">Netarabia</a>
                        </p>
                    </div>
    ...
    <!-- <button class="scroll-top scroll-to-target" data-target="html"><span
                        class="fal fa-angle-up"></span></button> -->

    <button style="background: transparent; width: 90px;" class=" animated   slow infinite scroll-top scroll-to-target"
        data-target="html"><img src="{{ asset('front/assets/images/balloon.png') }}" alt="">
    </button>
    <!-- jequery plugins -->
...
<!-- Mirrored from demo.dedemao.com/h5/13482/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 12:06:59 GMT -->
