            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.tours.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ $tour->title }}" required
                            autofocus>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="adult_price" class="form-control" value="{{ $tour->adult_price }}"
                            required autofocus>
                    </div>
                    <div class="form-group">
                        <label>@lang('tours.child_price')<span class="text-danger">*</span></label>
                        <input type="text" name="child_price" class="form-control" value="{{ $tour->child_price }}"
                            required autofocus>
                    </div>
