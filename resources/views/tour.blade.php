                    ...
                    <div class="tour-details-content">
                        ...
                        <div class="overview-inner">
                            <ul class="overview-list clearfix">
                                <li>
                                    <span>Destination:</span>New York City
                                </li>
                                <li>
                                    <span>Departure:</span>Yes Requard
                                </li>
                                <li>
                                    <span>Departure Time:</span>New York City
                                </li>
                                <li>
                                    <span>Return Time:</span>English &amp; Spanish
                                </li>
                                <li class="clearfix">
                                    <span>Included:</span>
                                    <ul class="included-list clearfix">
                                        ...
                                        <li>4 Nights Hotel Accomodation
                                        </li>
                                        <li>Entrance Fees
                                        </li>
                                        <li>Tour Guide
                        ...
                        <div class="photo-gallery">
                            ...
                            <div class="image-box clearfix">
                                <figure class="image">
                                    <img src="assets/images/resource/destination-4.jpg" alt=""><a
                                        href="assets/images/resource/destination-4.jpg" class="view-btn lightbox-image"
                                        data-fancybox="gallery"><i class="icon-Plus"></i></a>
                                </figure>
                                <figure class="image">
                                    <img src="assets/images/resource/destination-5.jpg" alt=""><a
                                        href="assets/images/resource/destination-5.jpg" class="view-btn lightbox-image"
                                        data-fancybox="gallery"><i class="icon-Plus"></i></a>
                                </figure>
                                <figure class="image">
                                    <img src="assets/images/resource/destination-6.jpg" alt=""><a
                                        href="assets/images/resource/destination-6.jpg" class="view-btn lightbox-image"
                                        data-fancybox="gallery"><i class="icon-Plus"></i></a>
                                </figure>
                                <figure class="image">
                                    <img src="assets/images/resource/destination-7.jpg" alt=""><a
                                        href="assets/images/resource/destination-7.jpg" class="view-btn lightbox-image"
                                        data-fancybox="gallery"><i class="icon-Plus"></i></a>
                                </figure>
                                <figure class="image">
                                    <img src="assets/images/resource/destination-8.jpg" alt=""><a
                                        href="assets/images/resource/destination-8.jpg" class="view-btn lightbox-image"
                                        data-fancybox="gallery"><i class="icon-Plus"></i></a>
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="comment-box">
                            <div class="text">
                                ...
                                <ul class="list clearfix">
                                    ...
                                    <li>
                                        <h5>
                                            Transport:
                                        </h5><i class="far fa-star"></i><i class="far fa-star"></i><i
                            ...
                            <form action="http://demo.dedemao.com/h5/13482/tour-details.html" method="post"
                                class="comment-form">
                                <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                    <div class="default-sidebar tour-sidebar ml-20">
                        ...
                        <div class="sidebar-widget downloads-widget">
                            ...
                            <div class="widget-content">
                                <ul class="download-links clearfix">
                                    <li>
                                        <a href="destination-details.html">Travel Direction<i
                                                class="fas fa-download"></i></a>
                                    </li>
                                    <li>
                                        <a href="destination-details.html">Documetation<i class="fas fa-download"></i></a>
                                    </li>
                                    <li>
                                        <a href="destination-details.html">Logo &amp; Assets<i
                                                class="fas fa-download"></i></a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="advice-widget">
                            <div class="inner-box"
                                style="background-image: url(assets/images/resource/advice-1.jpg);">
                                <div class="text">
                                    <h2>
                                        Get<br>
                                        25% Off<br>
